...
responsePage        = responsePage.replaceAll("payment-recurring.jsp", "response.jsp");
%>
<!DOCTYPE html>
<html>
<head>
		...
		<section class="payment-form dark">
			<div class="container">
				<div class="block-heading">
		        	...
		        	<h2>Web/Mobile - Recurring Billing</h2>
		        </div>
	        	<div class="content">
	        		<div class="row">
	        			<div class="col-md-12 col-lg-8">
	        				<div class="products">
	        					<form id="payment_form" action="./payment-confirm.jsp" method="post">
								    ...
								    <div id="paymentDetailsSection" class="section">
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control form-control-sm" name="transaction_type" value="create_payment_token">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-4 col-form-label col-form-label-sm">subscription only:</label>
											<div class="col-sm-8">
												<input type="checkbox" id="create_token" onclick="createToken(this)"  checked="checked">
											</div>
										</div>
										<div class="form-group row">
										...
										<div class="form-group row">
											<label class="col-sm-4 col-form-label col-form-label-sm"><strong style="color: coral;">recurring_frequency</strong></label>
											<div class="col-sm-4">
												<input type="text" class="form-control form-control-sm" name="recurring_frequency" value="monthly">
											</div>
											<div class="col-sm-4">
										...
										<div class="form-group row">
											<label class="col-sm-4 col-form-label col-form-label-sm" style="font-size: .790rem;"><strong style="color: coral;">recurring_number_of_installments</strong></label>
											<div class="col-sm-2">
												<input type="text" class="form-control form-control-sm" name="recurring_number_of_installments" value="60">
											</div>
											<div class="col-sm-6">
												<small>(261: Weekly, 60: Monthly, 5: Annually)</small>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-4 col-form-label col-form-label-sm"><strong style="color: coral;">recurring_start_date</strong></label>
											<div class="col-sm-8">
												<input type="text" class="form-control form-control-sm" name="recurring_start_date" value="<%= getDateTime("yyyyMMdd") %>">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-4 col-form-label col-form-label-sm"><strong style="color: coral;">recurring_amount</strong></label>
											<div class="col-sm-8">
												<input type="text" class="form-control form-control-sm" name="recurring_amount">
											</div>
										</div>
										<div class="form-group row">
