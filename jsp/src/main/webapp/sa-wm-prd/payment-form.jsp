	        		...
	        		<div class="row">
	        			<div class="col-md-12 col-lg-8">
	        				<div class="products">
	        					<form class="form-horizontal" id="payment_form" action="./payment-confirm.jsp" method="post">
								    ...
								    <input type="hidden" name="item_0_unit_price" value="0.50" />
								    ...
								    <input type="hidden" name="item_1_quantity" value="1" />
								    <input type="hidden" name="item_1_unit_price" value="0.50" />
	        			...
	        			<div class="col-md-12 col-lg-4">
			 				<div class="summary">
					            ...
					            <div class="total">Total<span class="price">฿1.00</span></div>
				 			</div>
			 			</div>
	        		</div>
	        		<hr>
