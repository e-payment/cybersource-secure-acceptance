...
responsePage = responsePage.replaceAll("payment-token.jsp", "response.jsp");
%>
<!DOCTYPE html>
<html>
<head>
	        				...
	        				<div class="products">
	        					<form class="form-horizontal" id="payment_form" action="./payment-confirm.jsp" method="post">
								    ...
								    <div id="paymentDetailsSection" class="section">
										...
										<div class="form-group row">
											<label class="col-sm-4 col-form-label col-form-label-sm"><strong style="color: coral;">payment_token</strong></label>
											<div class="col-sm-8">
												<input type="text" class="form-control form-control-sm" name="payment_token" value="5282547059466593203529">
											</div>
										</div>
										<div class="form-group row">
