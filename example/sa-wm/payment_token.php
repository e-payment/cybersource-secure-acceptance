...
<form id="payment_form" action="payment_confirm.php" method="post">
    ...
    <fieldset>
        ...
        <div id="paymentDetailsSection" class="section">
            ...
            <span>transaction_type:</span>            <input type="text" name="transaction_type" value="authorization"><br/>
            <span>reference_number:</span>            <input type="text" name="reference_number"><br/>
            <span>payment_token:</span>               <input type="text" name="payment_token" value="4895693800226230904102"><br/>            
