...
<form id="payment_form" action="payment_confirmation.aspx" method="post">
    ...
    <input type="hidden" name="access_key" value="2be4d01930a43c119ba921a1d893b597"/>
    ...
    <fieldset>
        ...
        <div id="paymentDetailsSection" class="section">
            ...
            <span>reference_number:</span><input type="text" name="reference_number" size="25" value="<% Response.Write(getUUID()) %>"><br/>
